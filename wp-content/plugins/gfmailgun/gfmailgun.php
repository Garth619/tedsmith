...
if (class_exists("GFForms")) {
    ...
    class GFSimpleAddOn extends GFAddOn {
        ...
        function htmlrow($label,$text,$rowcount){
            ...
            */
            return '<tr>
                                <td align="left" valign="top" font style="font-family: calibri;" >
                                <span style="font-weight: bold; color: #095BA7;">'.$label.':</span></td>
                            </tr>
                            <tr>
                                <td align="left" valign="top" bgcolor="#e5e5e5" font style="font-family: calibri;">
                                <span style="font-weight: bold; color: #0954A3;"><span style="font-weight: normal; color: #333; font-family: calibri;">'.$text.'</span></span></td>
                            </tr>';
        }
                ...
                <tr>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="10" cellspacing="0" width="100%" id="emailHeader" bgcolor="#e5e5e5">
                            <tr>
                                <td align="center" valign="top" font style="font-family: arial; font-size: 18px; color=; font-weight: bold;"#fff">
                                    Website Contact                                </td>
